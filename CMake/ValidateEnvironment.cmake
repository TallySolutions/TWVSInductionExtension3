...
macro (install_patch_libssl_forubuntu22)
    ...
    if(outvar MATCHES "22.04")
            ...
            message(NOTICE "pos ${pos} ")
            if(pos STREQUAL "-1")
                    execute_process(COMMAND "sudo sed -i 's/openssl_conf = openssl_init/#openssl_conf = openssl_init/g' /etc/ssl/openssl.cnf"  OUTPUT_VARIABLE outvar RESULT_VARIABLE retCode ERROR_VARIABLE error)
                    if(NOT retCode STREQUAL "0")
                            message(SEND_ERROR "Failed to execute sudo sed -i 's/openssl_conf = openssl_init/#openssl_conf = openssl_init/g' /etc/ssl/openssl.cnf")
                    endif()
            endif()
    endif()
endmacro()
